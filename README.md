...
| **admin.html** | 2.6.0 | Admin panel: Sweet Spot level editor, Picture Perfect image manager, site/index config, leaderboards, **Privacy tab** (legacy cleanup, delete a student, quarterly retention, picture sources). Admin-only: checks with the database and signs anyone else out. |
...
| **privacy-tools.js** | 1.0.0 | Admin privacy tools (cleanup, delete, retention, picture sources). Imported by admin.html; tested directly. |
